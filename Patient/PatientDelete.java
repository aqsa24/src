...
public class PatientDelete extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PatientDelete frame = new PatientDelete();
	...
	public PatientDelete() {
		...
		JLabel lblId = new JLabel("Enter Patient ID To delete:");
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				pat.delete_patient1(textField.getText());
			}
		});
		...
		JLabel lblDeletePatientRecord = new JLabel("Delete Patient Record");
