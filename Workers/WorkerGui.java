...
public class WorkerGui extends JFrame {
	...
	public WorkerGui() {
		...
		lblAddress.setBounds(238, 108, 63, 14);
		contentPane.add(lblAddress);
		
		textField_5 = new JTextField();
		textField_5.setBounds(248, 139, 227, 48);
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				c.add_Worker1(textField.getText(), textField_1.getText(), textField_1.getText(), textField_6.getText(), textField_2.getText(),textField_3.getText(), textField_4.getText(), textField_5.getText());
			}
		});
		...
		JLabel lblWorkerInsertion = new JLabel("Worker Insertion");
		...
		lblPay.setBounds(238, 46, 46, 14);
		contentPane.add(lblPay);
		
		textField_6 = new JTextField();
		textField_6.setBounds(343, 44, 132, 20);
